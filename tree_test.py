...
test_keys_list = ['seed', 'link1', 'link2', 'link3', 'link4', 'link5', 'link6', 'link7', 'link8', 'link9', 
'link10', 'link11', 'link12']

test_tree = Tree(test_dictionary, test_keys_list)

test_tree.Get_Current_Node()
test_tree.Get_Current_Level()
test_tree.get_Initial_Position()
test_tree.Get_Back_Position()
test_tree.Get_Front_Position()

#Back_One_Position() Function needs an 1 as parameter for advance
test_tree.Back_One_Position(1) #in this moment we are in the seed, not is possible back one position

#Advance_One_Position() Function receive a number as index for advance to a son
test_tree.Advance_One_Position(2)
print("**************************")
print("**************************")
print("after advance one position: ")
test_tree.Get_Current_Node()
test_tree.Get_Current_Level()
test_tree.get_Initial_Position()
test_tree.Get_Back_Position()
...
test_tree.Advance_To_Siblings(3)
print("after of moving to a sibling")
test_tree.Get_Current_Node()
test_tree.Get_Current_Level()
test_tree.get_Initial_Position()
test_tree.Get_Back_Position()
...
test_tree.Advance_One_Position(0)
print("after advance two position: ")
test_tree.Get_Current_Node()
test_tree.Get_Current_Level()
test_tree.get_Initial_Position()
test_tree.Get_Back_Position()
...
test_tree.Back_One_Position(1)
print("after back one position: ")
test_tree.Get_Current_Node()
test_tree.Get_Current_Level()
test_tree.get_Initial_Position()
test_tree.Get_Back_Position()
